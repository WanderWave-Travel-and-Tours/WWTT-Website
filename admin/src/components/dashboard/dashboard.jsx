  ...
  const fetchDashboardData = async () => {
    ...
    try {
      const bookingsRes = await fetch(
        "https://wanderwaveph-backend.onrender.com0/api/admin/bookings"
      );
      if (!bookingsRes.ok)
    ...
    try {
      const packagesRes = await fetch("https://wanderwaveph-backend.onrender.com0/api/packages");
      if (!packagesRes.ok)
    ...
    try {
      const blogsRes = await fetch("https://wanderwaveph-backend.onrender.com0/api/blogs");
      if (!blogsRes.ok)
    ...
    try {
      const promosRes = await fetch("https://wanderwaveph-backend.onrender.com0/api/promos");
      if (!promosRes.ok)
    ...
    try {
      const testimonialsRes = await fetch(
        "https://wanderwaveph-backend.onrender.com0/api/testimonials"
      );
    ...
    try {
      const inquiriesRes = await fetch(
        "https://wanderwaveph-backend.onrender.com0/api/inquiries"
      );
      if (!inquiriesRes.ok)
