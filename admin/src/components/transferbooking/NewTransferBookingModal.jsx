            ...
            <>
              ...
              <div className="nbm-card" style={{ marginTop: 20 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                  ...
                  <div className="nbm-field">
                    <label>Arrival Time <span style={{ color: '#ef4444' }}>*</span></label>
                ...
                {tripType === 'roundtrip' && (
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginTop: 16 }}>
                    ...
                    <div className="nbm-field">
                      <label>Departure Time <span style={{ color: '#ef4444' }}>*</span></label>
                ...
                <div style={{ background: 'linear-gradient(135deg, #fff9f0, #fefce8)', border: '2px solid #fcd34d', borderRadius: 14, padding: '16px 20px', marginBottom: 24, display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 10 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: '0.78rem', color: '#92400e' }}>{tripType === 'roundtrip' ? '↔ Roundtrip' : '→ One Way'} · {paxCount} pax · {travelDate}</div>
                    </div>
                  </div>
                  <div style={{ fontWeight: 800, fontSize: '1.4rem', color: '#f59e0b' }}>₱{sellingPrice.toLocaleString()}</div>
                </div>
              )}
