...
const SellerRate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = editingRate 
        ? `/api/seller-rates/${editingRate._id}`
        : '/api/seller-rates';
  ...
  const handleFlexibleUpload = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/seller-rates/bulk', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleDelete = (id) => {
    setConfirmConfig({
      ...
      onConfirm: async () => {
        try {
          const response = await fetch(`/api/seller-rates/${id}`, {
            method: 'DELETE'
          });
    ...
    setConfirmConfig({
      ...
      onConfirm: async () => {
        try {
          ...
          const response = await fetch(`/api/seller-rates/${id}/archive`, {
