                ...
                <div className="pdm-body">
                    ...
                    <div className="pdm-section-card dashed-border">
                        ...
                        <div className="pdm-image-box">
                            <img 
                                src={`https://wanderwaveph-backend.onrender.com0/${selectedPoster.imageUrl}`} 
                            ...
                            <div className="pdm-image-info">
                                ...
                                <button className="pdm-view-link" onClick={() => window.open(`https://wanderwaveph-backend.onrender.com0/${selectedPoster.imageUrl}`, '_blank')}>
                                    View Full Image
                                </button>
                            </div>
                        </div>
