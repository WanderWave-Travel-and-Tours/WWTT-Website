                  ...
                  <div className="cnm-file-list" style={{ marginBottom: '20px' }}>
                    ...
                    {finalSentDocs.map((doc, idx) => (
                      <div key={doc._id || idx} className="cnm-file-item" style={{ 
                        ...
                        <a 
                          href={`https://wanderwaveph.onrender.com${doc.fileUrl}`} 
                          target="_blank" 
                ...
                <div className="cnm-doc-list">
                  {clientDocs.map((doc) => (
                    <div key={doc._id} className="cnm-doc-item">
                      ...
                      <a href={`https://wanderwaveph.onrender.com${doc.fileUrl}`} target="_blank" rel="noopener noreferrer" className="cnm-btn cnm-btn-ghost cnm-btn-sm">
                        <TrendingUp size={14} /> View
                      </a>
                    </div>
                  ))}
