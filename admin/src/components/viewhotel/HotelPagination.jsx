    ...
    return (
        <nav className="hp-pagination-nav">
            <div className="hp-pagination-info">
                <span className="hp-pagination-showing">
            ...
            <div className="hp-pagination-controls hp-large-only">
                {/* Empty space for large screens */}
            </div>

            <div className="hp-pagination-jump">
                <button
                    type="button"
                ...
                <form onSubmit={handleJump} className="hp-pagination-jump-form">
                    <span className="hp-pagination-jump-label">Page</span>
                    <input 
                        type="number" 
                        value={jumpPageInput}
                        ...
                        min="1" 
                        max={totalPages}
                        className="hp-jump-input"
                    />
                    <span className="hp-pagination-jump-label">of {totalPages}</span>
                </form>
