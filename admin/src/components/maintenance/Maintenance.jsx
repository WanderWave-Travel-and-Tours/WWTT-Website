            ...
            <div className="maintenance-card">
                ...
                <div className="maintenance-visual">
                    ...
                    <div className="maintenance-visual-content">
                        <Coffee size={48} style={{ marginBottom: '16px', color: '#f59e0b' }} />
                ...
                <div className="maintenance-content">
                    ...
                    <p className="maintenance-desc">
                        Sorry for the delay! We are currently updating the system to serve you better. Grab a coffee, we'll be back online before you know it.
                    </p>
