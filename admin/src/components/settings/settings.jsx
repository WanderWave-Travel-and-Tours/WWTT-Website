...
const Settings = () => {
    ...
    useEffect(() => {
        const fetchSettings = async () => {
            try {
                const response = await fetch('https://wanderwaveph.onrender.com/api/admin/settings');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://wanderwaveph.onrender.com/api/admin/update-settings', {
                method: 'PUT',
                body: formData
            });
            const result = await response.json();
                            ...
                            <div className="logo-upload-wrapper">
                                <div className="logo-preview-box">
                                    {previewUrl ? (
                                        ...
                                        <img src={`https://wanderwaveph.onrender.com/uploads/${settings.businessLogo}`} alt="Business Logo" />
                                    ) : (
