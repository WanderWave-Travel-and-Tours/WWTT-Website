...
const TransferPaymentSuccess = () => {
  ...
  const normalizeBooking = (booking, paymentTypeParam) => {
    ...
    return {
      ...
      title: booking.activityName || 'Transfer Service',
      subTitle: `${route || booking.pickupLocation || ''}${booking.transferType ? ` (${booking.transferType})` : ''}`,
      dateLabel: 'Travel Date',
      dateValue: booking.travelDate,
      ...
      <div className="success-container">
        <div className="success-card">
          ...
          <p className="success-subtitle">
            {details?.isPartial
              ? "Your initial payment has been confirmed. We'll contact you for the remaining balance before your transfer."
              : 'Your transfer has been secured. See you soon!'}
          </p>

          {details && (
            <div className="booking-info-card">
              <h3 className="info-title">Transfer Booking Details</h3>

              <div className="info-grid">
                <div className="info-item">
                  <span className="info-label">Reference ID</span>
                  <strong className="info-value tps-info-value-reference">
                    {details.reference}
                  </strong>
                </div>
          ...
          {details?.isPartial && (
            <div className="payment-notice">
              <strong>Note:</strong> The remaining balance of ₱{details.remainingBalance?.toLocaleString()} must be paid before your transfer date.
          ...
          <div className="success-footer">
            ...
            <button className="btn-link" onClick={handleClose}>
              <Home size={16} className="tps-home-icon" />
              Close
            </button>
          </div>
        </div>
...
export default TransferPaymentSuccess;
