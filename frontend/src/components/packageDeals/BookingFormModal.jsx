...
const BookingFormModal = ({ 
  ...
  // ============================================
  // CONFIRM BOOKING ACTION - PAYMENT FLOW
  // ✅ FIX: Booking is NOT created here.
  //    We only create a PayMongo checkout session.
  //    The booking will be created by the webhook
  ...
  const handleConfirmBooking = async () => {
    ...
    try {
      ...
      // ✅ No bookingId needed here — it doesn't exist yet.
      //    bookingId is generated by the webhook after payment.
      // ============================================
      const fullBookingData = {
        ...
        // ✅ No bookingId field — booking does not exist yet at this point.
        //    It will be created inside paymentRoute.js webhook handler
        //    only after PayMongo confirms payment success.
      };

      // ============================================
      // CALL PAYMENT ENDPOINT - creates PayMongo checkout session only
      // Booking creation happens in webhook after successful payment
      // ============================================
      ...
      if (response.data.success && response.data.checkoutUrl) {
        ...
        // ✅ Store session ID in sessionStorage so payment-success page
        //    can verify the session and show booking details
