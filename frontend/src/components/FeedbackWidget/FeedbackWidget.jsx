...
import { X, MessageSquare, Send, Star, Sparkles, Bug, FileText, Upload } from 'lucide-react';
...
const FeedbackWidget = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // ============================================================
      // FIX APPLIED HERE:
      // Removed 'process.env' to prevent "process is not defined" error.
      // Used your Render URL directly to match FeedbackManagement.jsx
      // ============================================================
