...
function FlightSearch({ onFlightSelect, prefilledDepartureDate, prefilledDestination, prefilledPassengers }) {
      ...
      const searchDestination = async () => {
        try {
          const response = await axios.get(
            "https://wanderwaveph-backend.onrender.com0/api/flights/airports",
  ...
  const handleSearch = async (e) => {
    ...
    try {
      const response = await axios.get("https://wanderwaveph-backend.onrender.com0/api/flights/search-domestic", {
          params: { 
            ...searchData, 
